...
class PreMemberController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('idcard')) {
            $validatedData['idcard'] = $request->file('idcard')->store('post-images');
        }

        Member::create($validatedData);
        // Member::create($validatedData);
        return redirect('/')->with('success', 'Your data will be check by Librarian, we will inform you from your email!');
    }
